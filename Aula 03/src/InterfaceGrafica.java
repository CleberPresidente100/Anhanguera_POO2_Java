...
public class InterfaceGrafica extends JFrame {
    ...
    public CRUD controle = new CRUD();//dará um erro, pois ainda não foi criada a classe
    //CRUD.Pode deixar comentado nesse momento, mas depois descomentar .
...
//preencher depois
        ...
        try {
            ...
            while(dados.next()){
                ...
                modelo.addRow(new Object[]{id, nome, idade,ra});
            }
        }catch(Exception ex) {
            ex.printStackTrace();
        }
